        ...
        <Stack direction="row" justifyContent="space-between" marginTop={5} spacing={4}>
          ...
          <div>
            <Button
              ...
              variant="contained"
              onClick={() => {
                changePage.push(`/Admin/lessons/add_lesson/${id}`);
              }}
            >
              Add
            </Button>
              ...
              id === lesson.subject_id && (
                <Grid item xs={3} key={lesson._id}>
                  ...
                  >
                    <CardActionArea
                      onClick={() => {
                        router.push(`/Admin/lessons/lessonDetails/${lesson._id}`);
                      }}
                    >
                      <CardContent>
                      ...
                      <CardMedia
                        component="img"
                        height="140"
                        image={`http://localhost:8080/images/${lesson.image}`}
                      />
                    </CardActionArea>
                    <CardActions
                    ...
                    >
                      {/* <Button size="small" color="success" variant="contained">
                        <Link
                          href={`/Admin/lessons/editLesson/${lesson._id}`}
